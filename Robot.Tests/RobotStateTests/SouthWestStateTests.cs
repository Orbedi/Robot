...
{
    internal class SouthWestStateTests
    {
        ...
        public void SetUp()
        {
            ...
            _robot = new MyRobot(new SouthWestState(), 1, 1, board);
        }

        [Test]
        [Category("StateTest")]
        public void SouthWestState_Move_X1Y1()
        {
            _robot.State.Move();
        ...
        [Test]
        [Category("StateTest")]
        public void SouthWestState_TurnLeft_StateEqualsSouthState()
        {
        ...
        [Test]
        [Category("StateTest")]
        public void SouthState_TurnRight_StateEqualsWestState()
        {
